node {
    ...
    stage('Build image') {
        ...
        app = docker.build("535597585675.dkr.ecr.ap-northeast-2.amazonaws.com/product_ci")
    }
    ...
    stage('Push image') {
        ...
        docker.withRegistry('https://535597585675.dkr.ecr.ap-northeast-2.amazonaws.com', 'ecr:ap-northeast-2:product_ci_aws-credentials') {
